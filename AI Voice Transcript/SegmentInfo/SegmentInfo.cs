...
namespace AIVoiceTranscript
{
    public class SegmentInfo
    {
        ...
        public static List<SegmentInfo> AddSegmentInfo(string speaker, string text, int start, int end)
        {
            ...
            segments.Add(new SegmentInfo
            {
                ...
                Start = start,
                End = end,
                ExtractedSegmentPath = string.Empty, //empty by default 
                ExtractedSegmentName = string.Empty, //empty by default 
